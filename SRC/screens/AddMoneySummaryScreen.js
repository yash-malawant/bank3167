...
const AddMoneySummaryScreen = ({navigation}) => {
    return (
            ...
            <View style={{
                ...
                >
                    <View style={{
                        ...
                        <Text style={styles.AvailableText}>Add Ammount</Text>
                    </View>
                    <View style={{
                        height: HEIGHT / 2.1,
                        marginTop: 10,
                        ...
                        <TouchableOpacity 
                        // onPress={() => { navigation.navigate('WithdrawSuccessScreen')}}
...
export default AddMoneySummaryScreen;