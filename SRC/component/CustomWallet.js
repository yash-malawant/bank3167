...
import { StyleSheet, View, Text, SafeAreaView, ImageBackground, TextInput, ScrollView, Image, Modal, TouchableOpacity, Platform, StatusBar } from 'react-native';
        ...
        return (
            <RBSheet
                ...
                <View style={{ paddingLeft: 15, marginTop: 10 }}>
                    <Text style={styles.sendMoneyText}>Add Custom Wallet</Text>
                </View>
                ...
                <TouchableOpacity
                    ...
                    <Text style={styles.signTextStyle}>Add Now</Text>
                </TouchableOpacity>
            </RBSheet>
        )
    }
                ...
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity
                        ...
                        <View style={styles.sliderSTyle}>
                            ...
                            <Text style={styles.sliderAmmountText}>£5,23.45</Text>
                    ...
                    >
                        <View style={styles.addWalletView}>
                            <WithLocalSvg width="94" height="71" asset={require('../assets/images/add_custom.svg')} />
                        </View>
                    </TouchableOpacity>
                </View>
